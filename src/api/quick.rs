//! Quick one-shot convenience functions for common plot types.

use crate::api::figure::Figure;
use crate::api::grid::GridData;
use crate::api::options::PlotOption;
use crate::api::axes3d::SurfaceStyle;
use crate::canvas::{BrailleCanvas, PALETTE};
use crate::layout::{LayoutConfig, compute_layout, generate_ticks, render_frame};
use crate::transform::{CoordinateMapper, aligned_x_pixel_range, aligned_y_pixel_range, clip_line};

/// Quick one-shot plot of a line series. Returns the rendered string.
///
/// For the full builder API, see [`LinePlot`](crate::api::plots::LinePlot) and
/// [`Layout2D`](crate::api::axes::Layout2D).
///
/// # Examples
///
/// ```
